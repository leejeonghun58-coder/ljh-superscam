...
import { getDemandProfile, getShipmentTrend } from '@/lib/scm';

export const dynamic = 'force-dynamic';

export default async function AgentPage() {
  await requireUser();
  const [{ rows: trends, error: trendError }, { rows: profiles, error: profileError }] = await Promise.all([getShipmentTrend('ALL'), getDemandProfile('ALL')]);
